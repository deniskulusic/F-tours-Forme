...
var x = document.getElementsByClassName("tab");
  ...
  var yx=x[2].querySelectorAll('input[name="spol"]');
   var xy=x[2].querySelectorAll(".big label");
      ...
      var zw=x[3].querySelectorAll(".checkbox input");
      var zq=x[3].querySelectorAll(".checkbox label");
      zw[0].addEventListener('click',function(){
        zq[0].classList.remove("invalid");
      });
      zw[1].addEventListener('click',function(){
        zq[1].classList.remove("invalid");
      });
